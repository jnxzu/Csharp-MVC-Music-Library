...
namespace C__MVC___Music_Library.Controllers
{
    public class TracksController : Controller
    {
        ...
        public TracksController(MusicLibContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Duration")] Track track)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Duration")] Track track)
        {
            if (id != track.Id)
            {
                return NotFound();
